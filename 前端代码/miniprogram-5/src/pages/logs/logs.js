...
function toMillis(value) {
  ...
  if (Array.isArray(value)) {
    const y = value[0], m = value[1], d = value[2], hh = value[3], mm = value[4], ss = value[5]
...
Page({
  ...
  async reload(options = {}) {
    ...
    try {
      const _resAll = await Promise.all([
      ...
      const batches = _resAll[0], planting = _resAll[1], processing = _resAll[2], inspection = _resAll[3], shipments = _resAll[4]
