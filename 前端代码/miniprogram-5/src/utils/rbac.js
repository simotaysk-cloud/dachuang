...
const FEATURE_MATRIX = {
  ...
  FARMER: ['PLANTING'],
  MANUFACTURER: ['PROCESSING', 'LOGISTICS', 'QRCODE', 'DASHBOARD'],
  FACTORY: ['PROCESSING', 'LOGISTICS', 'QRCODE', 'DASHBOARD'],
  LOGISTICS: ['LOGISTICS', 'DASHBOARD'],
  QUALITY: ['INSPECTION', 'QRCODE', 'DASHBOARD'],
  REGULATOR: ['PROCESSING', 'LOGISTICS', 'INSPECTION', 'SECURITY', 'TERMINAL_QRCODE', 'DASHBOARD', 'LOGS', 'QRCODE'],
  USER: []
}
